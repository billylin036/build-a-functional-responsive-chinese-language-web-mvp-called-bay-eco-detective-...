    ...
    quiz: [
      {
        ...
        skill: "系统思维",
        difficulty: "基础",
        question: "一场强降雨发生在入湾河流上游。为什么几天后的海湾观察也值得关注？",
        options: [
          "径流可能把上游物质经河流和排水系统带入海湾",
          "海湾与陆地完全隔离",
          "降雨会让所有污染物自动消失",
          "只要海面颜色没变，就不需要继续观察",
        ],
        answerIndex: 0,
        hint: "把上游、河流、排水系统和海湾看成一个连通系统。",
        explanation: "流域中的水和物质会沿径流路径移动，因此海湾调查需要关注上游事件和时间延迟。",
        sourceIds: ["outfall-source"],
      },
      {
        id: "bay-watershed",
      ...
      },
      {
        ...
        skill: "精确阅读",
        difficulty: "进阶",
        question: "使用多年前的环境调查资料时，哪种表达最科学？",
        options: [
          "把历史观察直接写成今天的现状",
          "保留调查年份，并说明判断当前状况还需要重新调查",
          "删除调查方法，只保留最醒目的结论",
          "没有新数据时，把历史数值复制成今年的数据",
        ],
        answerIndex: 1,
        hint: "历史资料可以提供基线，但不能自动代表现在。",
        explanation: "明确时间边界既保留了历史资料的价值，也避免把过去的观察误当成当前事实。",
        sourceIds: ["outfall-source"],
      },
      {
        id: "coordinate-limit",
        skill: "证据边界",
        difficulty: "挑战",
        question: "地图坐标、现场观察和实验室检测分别回答什么问题？",
        options: [
          "坐标回答在哪里；观察描述现象；检测提供特定指标的测量结果",
          "三者都能单独证明污染来源",
          "只要有坐标，就不需要记录日期和方法",
          "现场照片可以自动替代所有检测",
        ],
        answerIndex: 0,
        hint: "不同证据有不同功能，不能互相替代。",
        explanation: "坐标、观察和检测构成互补证据；科学结论需要把每类证据放在正确的范围内解释。",
    ...
    quiz: [
      {
        ...
        skill: "观察表达",
        difficulty: "进阶",
        question: "学生看到排口附近有泡沫和异味，哪条记录最适合进入调查表？",
        options: [
          "这里一定有某家工厂偷排",
          "记录日期、位置、泡沫范围和气味，并把污染来源列为待验证问题",
          "只写“水很脏”",
          "为了让结论更强，省略天气和潮位",
        ],
        answerIndex: 1,
        hint: "把看见的现象与尚未验证的原因分开。",
        explanation: "可复核记录需要时间、地点和具体可见现象；污染来源必须通过进一步调查验证。",
        sourceIds: ["outfall-source"],
      },
      {
        id: "portable-limit",
      ...
      },
      {
        ...
        skill: "数据解释",
        difficulty: "挑战",
        question: "一张快速检测表没有标明单位和完整方法时，最合适的处理是什么？",
        options: [
          "自行猜测单位，再换算成官方等级",
          "保留原始记录并明确缺失信息，不做超出证据的判级",
          "删除所有范围值，只保留一个平均数",
          "把空白项目自动记为零",
        ],
        answerIndex: 1,
        hint: "不知道的信息应当被标为缺失，而不是被补造。",
        explanation: "透明保留数据和局限，才能让后续调查者知道哪些结论可以支持、哪些信息需要补充。",
    ...
    quiz: [
      {
        ...
        skill: "概念整合",
        difficulty: "基础",
        question: "为什么评价红树林时不能只数树木数量？",
        options: [
          "因为树木数量与生态系统没有任何关系",
          "因为还要观察水文连接、生境结构、动物利用和长期存活",
          "因为只需要测量游客数量",
          "因为种植当天的照片已经足够",
        ],
        answerIndex: 1,
        hint: "生态系统包含植物、水、沉积物和其他生物。",
        explanation: "树木数量只是一个输入或结构指标；生态恢复还需要长期、多维度的功能证据。",
      ...
      },
      {
        ...
        skill: "调查设计",
        difficulty: "进阶",
        question: "要比较两个季节的候鸟利用情况，怎样记录最可靠？",
        options: [
          "每次随意选择地点和观察时长",
          "使用相同样区和时长，并记录潮位、天气、种类和数量",
          "只保留鸟最多的一次观察",
          "观察者感觉差不多就不用写原始数量",
        ],
        answerIndex: 1,
        hint: "比较需要统一方法，并记录可能影响结果的背景条件。",
        explanation: "标准化样区、时长和环境信息能减少观察条件差异，使季节比较更有意义。",
      ...
      },
      {
        ...
        skill: "因果判断",
        difficulty: "挑战",
        question: "某修复区树苗存活率提高，能否立即证明整个湿地生态功能已经恢复？",
        options: [
          "可以，因为存活率能代表所有生态功能",
          "不能，还需水文、生境、底栖动物和鸟类等长期证据",
          "可以，只要树苗看起来很绿",
          "不能，因为任何生态恢复都无法评价",
        ],
        answerIndex: 1,
        hint: "一个指标改善不等于整个系统已经恢复。",
        explanation:
          "存活率很重要，但生态功能包含水文过程、食物网和生物多样性，需要多指标长期验证。",
        sourceIds: ["sengo-wetland"],
      },
      {
    ...
    quiz: [
      {
        ...
        skill: "安全与伦理",
        difficulty: "基础",
        question: "学生在湿地发现不明废物时，哪种行动最安全、最有价值？",
        options: [
          "直接进入软泥滩捡取并闻一闻",
          "在安全位置记录地点、时间和照片，并报告教师或管理人员",
          "为了拍近景追赶附近动物",
          "把废物带回教室再辨认",
        ],
        answerIndex: 1,
        hint: "不触碰未知物，也不要进入危险区域。",
        explanation: "公民科学首先要保证安全和不干扰生境；规范记录与报告仍能提供可追踪线索。",
      ...
      },
      {
        ...
        skill: "沟通不确定性",
        difficulty: "进阶",
        question: "一次观察没有发现某种鸟，最科学的结论是什么？",
        options: [
          "该物种已经从整个湿地消失",
          "本次、该地点和观察条件下未记录到，仍需重复调查",
          "观察者一定辨认错误",
          "以后不必再记录这个物种",
        ],
        answerIndex: 1,
        hint: "“没有观察到”不等于“确定不存在”。",
        explanation: "发现概率会受到季节、天气、时长和观察者影响；结论必须保留时空范围和不确定性。",
      ...
      },
      {
        ...
        skill: "成效评价",
        difficulty: "挑战",
        question: "一个项目参与人数很多，怎样才能进一步判断它是否改善了生态环境？",
        options: [
          "参与人数本身已经证明生态改善",
          "同时设置生态指标、基线、对照和长期重复监测",
          "只比较活动照片数量",
          "只统计社交媒体点赞数",
        ],
        answerIndex: 1,
        hint: "行动规模和生态结果是两类不同指标。",
        explanation: "参与数据描述投入与覆盖面；生态成效需要可比较的环境指标和足够长的监测时间。",
...
const explorationChapterQuestions: Record<number, ChapterQuizQuestion> = {
  1: {
    ...
    skill: "跨点比较",
    difficulty: "挑战",
    question: "同一流域两个点的快速检测结果不同，哪种解释最符合证据边界？",
    options: [
      "数值较高的点已被证明由某一种污染源造成",
      "先确认单位、方法、采样时间和水文条件一致，再通过重复检测研究原因",
      "一次结果就能代表两个地点所有年份的状况",
      "只比较一个指标就能确定完整水质等级",
    ],
    answerIndex: 1,
  ...
  2: {
    ...
    skill: "空间布点",
    difficulty: "挑战",
    question: "要研究河流交汇后的变化可能来自哪一股来水，最有信息量的布点方式是什么？",
    options: [
      "只在交汇后拍一张照片",
      "只在地图上比较两个地名",
  ...
  3: {
    ...
    skill: "谨慎推断",
    difficulty: "综合",
    question: "两个河流点位的 pH 数值不同，仅凭这项差异可以得出什么？",
    options: [
      "pH 较高的河流整体生态一定更健康",
      "pH 较低的点一定受到工业污染",
      "只能说明两点当次 pH 记录不同；完整比较还需其他指标、方法和重复采样",
      "pH 越高，所有污染物浓度就一定越低",
    ],
    answerIndex: 2,
